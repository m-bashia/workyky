  ...
  Widget build(BuildContext context) {
    return SliderTheme(
      ...
      child: GradientSlider(
        thumbAsset: 'assets/images/slider.png',
        thumbHeight: 30,
        thumbWidth: 10,
        trackHeight: 20,
...
class _GradientSliderState extends State<GradientSlider> {
  ...
  _loadImage() async {
    ...
    final ui.Codec codec = await ui.instantiateImageCodec(bytes, targetWidth: widget.thumbWidth, targetHeight: widget.thumbHeight);
...
class GradientSliderTrackShape extends SliderTrackShape with BaseSliderTrackShape {
  ...
  void paint(
    ...
    final ColorTween inactiveTrackColorTween =
        ColorTween(begin: sliderTheme.disabledInactiveTrackColor, end: inactiveTrackGradient != null ? Colors.white : sliderTheme.inactiveTrackColor);
    ...
    if (trackBorder != null || trackBorderColor != null) {
      ...
      canvas.drawRRect(
          RRect.fromLTRBAndCorners(trackRect.left, trackRect.top, trackRect.right, trackRect.bottom,
              topLeft: trackRadius, bottomLeft: trackRadius, bottomRight: trackRadius, topRight: trackRadius),
          strokePaint);
    }
  }
}
