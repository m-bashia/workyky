...
import 'add_workout_screen_widget_model.dart';

@RoutePage(
  name: AppRouteNames.addWorkoutScreen,
)
class AddWorkoutScreen extends ElementaryWidget<IAddWorkoutScreenWidgetModel> {
  AddWorkoutScreen({
    required this.loadAgain,
    Key? key,
    WidgetModelFactory wmFactory = addWorkoutScreenWidgetModelFactory,
  ...
  @override
  Widget build(IAddWorkoutScreenWidgetModel wm) {
    return Builder(
      builder: (context) {
        return Container(
